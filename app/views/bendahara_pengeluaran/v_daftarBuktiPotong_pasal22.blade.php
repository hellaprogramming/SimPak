...
@section('title', 'Daftar Bukti Potong Pasal 22')
@section('content')
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-list fa-1x"></i> Daftar Bukti Potong Pasal 22</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        ...
        <table class="table table-striped table-bordered table-hover tabel-daftar-potong">
            <thead>
                <tr>
                    ...
                    <th colspan="2"style="text-align: center;">Bukti Pemungutan</th>
                    <th rowspan="2" style="vertical-align: middle;text-align: center;">Nilai Obyek Pajak<br/>(Rp)</th>
                    <th rowspan="2" style="vertical-align: middle;text-align: center;">PPh yang<br/>Dipungut (Rp)</th>
                </tr>
                <tr>
        ...
        $('#cari-masa-pajak').submit(function(e){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(data.db.length){
                        $('.tbl-cetak').append('<a class="btn btn-success" onclick="cetak( 1, &quot;'+data.bln+'-'+data.thn+'&quot;)" ><i class="fa fa-print fa-fw"></i> CETAK</a>');
