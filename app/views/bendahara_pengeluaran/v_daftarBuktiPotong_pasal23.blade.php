...
@section('title', 'Daftar Bukti Potong Pasal 23')
@section('content')
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-list fa-1x"></i> Daftar Bukti Potong Pasal 23</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        ...
        <table class="table table-striped table-bordered table-hover tabel-daftar-potong">
            <thead>
                <tr>
                    ...
                    <th colspan="2"style="text-align: center;">Bukti Pemotongan</th>
        ...
        $('#cari-masa-pajak').submit(function(e){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(data.db.length){
                        $('.tbl-cetak').append('<a class="btn btn-success" onclick="cetak( 2, &quot;'+data.bln+'-'+data.thn+'&quot;)"><i class="fa fa-print fa-fw"></i> CETAK</a>');
